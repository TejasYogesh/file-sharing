  ...
  return (
    <div style={styles.page}>
      ...
      <div className="fade-up" style={styles.box}>
        ...
        <p style={styles.sub}>Start sharing files in seconds</p>
...
const styles = {
  ...
  glow: { position: "absolute", width: 500, height: 500, borderRadius: "50%", background: "radial-gradient(circle, rgba(250,109,138,0.12) 0%, transparent 70%)", top: "50%", left: "50%", transform: "translate(-50%, -50%)", pointerEvents: "none" },
  box: { width: "100%", maxWidth: 420, background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 20, padding: "2.5rem", position: "relative", zIndex: 1 },
  logo: { display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "2rem" },
  logoIcon: { fontSize: "1.5rem", color: "var(--accent2)" },
